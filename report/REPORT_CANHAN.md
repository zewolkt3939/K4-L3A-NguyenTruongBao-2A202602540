...
|---|-------|--------------------------------|-------|-----------|------------------------|
| 1 | Tôi muốn phúc khảo bài thi tự luận thì phải làm gì và trong thời hạn bao lâu? *(filter audience=student)* | `phuc-khao-nguoi-hoc`: mảnh nộp muộn ("...14 ngày làm việc, phải có sự đồng ý của Trưởng đơn vị chủ quản...") | 0.8142 | **0đ** (Không có trong top-3: mệnh đề nộp đơn Mẫu 12 bị chẻ đôi, rơi khỏi top-3) | [AGENT] Không tìm thấy quy trình nộp đơn đầy đủ trong top-3. Chỉ có thông tin nộp muộn sau 14 ngày làm việc cần Trưởng đơn vị đồng ý. |
| 2 | Thời lượng tối đa của một bài thi tự luận là bao nhiêu phút? | `hinh-thuc-thoi-luong-thi`: Điều 6 khoản 4d ("...tối thiểu 50 phút và tối đa là 120 phút...") | **0.9070** | **2đ** (Rất liên quan, Top-1) | [AGENT] Căn cứ Điều 6 khoản 4d [1]: Thời lượng tối đa của một bài thi tự luận là 120 phút (tối thiểu là 50 phút). |
| 3 | Đến phòng thi muộn bao lâu thì không được dự thi? | `nguoi-hoc-du-thi`: Điều 13 khoản 2 ("...đến muộn quá 15 phút sau khi đã phát đề thi sẽ không được dự thi...") | 0.8845 | **2đ** (Rất liên quan, Top-1) | [AGENT] Căn cứ Điều 13 khoản 2 [1]: Người học đến muộn quá 15 phút sau khi đã phát đề thi sẽ không được dự thi ca thi đó. |
| 4 | Hai giảng viên chấm tiểu luận lệch nhau từ 2 điểm trở lên thì xử lý thế nào? | `cham-thi`: Điều 21 khoản 3 (quy định chấm **tự luận**: mời người chấm thứ ba) | 0.8260 | **0đ** (Đúng file nhưng sai Điều: lấy nhầm Điều 21 thay vì Điều 24) | [AGENT] Hai giảng viên thảo luận thống nhất điểm; nếu không thống nhất được thì mời cán bộ chấm thi thứ ba (lưu ý: đây là quy định của bài thi tự luận). |
| 5 | Những lỗi vi phạm nào khiến người học bị đình chỉ thi? | `xu-ly-vi-pham-nguoi-hoc`: Điều 29 khoản 1c (nửa đầu điểm c: mang tài liệu cấm, đưa đề ra ngoài...) | 0.8410 | **1đ** (Có liên quan ở top-1 nhưng thiếu ý: danh sách dài bị cắt ngang, mất ý "không chấp hành yêu cầu CBCT") | [AGENT] Căn cứ Điều 29 khoản 1c [1]: Người học bị đình chỉ thi khi mang tài liệu/phương tiện cấm, đưa đề ra ngoài, tái phạm sau khi bị cảnh cáo (bài thi bị điểm 0). |

**Tổng điểm truy xuất của tôi:** **5 / 10 điểm** (Q1: 0đ, Q2: 2đ, Q3: 2đ, Q4: 0đ, Q5: 1đ).
